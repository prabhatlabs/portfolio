...
function Home() {
    return (
        <div className="h-dvh font-mono lg:overflow-y-hidden">
            <StatusBar />

            <div className="relative max-w-[1500px] mx-auto p-4 grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6 lg:gap-0">
                <div className="flex flex-col gap-6 md:max-w-md lg:max-w-xs xl:max-w-sm w-full mx-auto lg:mx-0">
                    <MyInfo />
                    <ConnectWithMe />
                    <Skills />
                </div>
                <div className="mb-4 pb-20 lg:px-6 flex flex-col w-full gap-6 lg:h-[calc(100dvh-4rem)] lg:overflow-y-auto hideScrollbar">
                    <GithubChart />

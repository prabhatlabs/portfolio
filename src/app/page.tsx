...
function Page() {
    return (
        <div className="max-w-screen overflow-hidden relative">
            ...
            <div className="grid min-h-dvh grid-cols-1 justify-center pt-12 [--gutter-width:2.5rem] md:-mx-4 md:grid-cols-[var(--gutter-width)_minmax(0,var(--breakpoint-xl))_var(--gutter-width)] lg:mx-0">

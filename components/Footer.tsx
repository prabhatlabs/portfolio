export default function Footer() {
    return (
        <div className="relative w-full p-4" id="footer">
            <div className="absolute z-0 bottom-0 left-0 w-full h-36">
                <div
            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-8 items-center">
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-extralight text-muted-foreground mb-10 md:mt-6">
                    {"prabhatlabs.dev"}
                </h1>
            </div>
